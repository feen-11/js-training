...
console.log('解答:"Boolean("0") === false, false');
console.log('Boolean(0) === false', Boolean(0) === false);
console.log('解答: "Boolean(0) === false", true');
console.log('!Boolean(0) === false', !Boolean(0) === false);
console.log('解答:"!Boolean(0) === false", false');
console.log('-1 == false', -1 == false);
console.log('解答:"-1 == false", false');
console.log('!10 === false', !10 === false);
console.log('解答:"!10 === false", true');
